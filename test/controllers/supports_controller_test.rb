...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { name: @support.name, phone: @support.phone, skype: @support.skype } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { name: @support.name, phone: @support.phone, skype: @support.skype } }
